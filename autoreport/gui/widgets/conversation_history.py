...
class SessionListItem(QWidget):
    ...
    def _setup_ui(self, name: str, timestamp: str, preview: str) -> None:
        ...
        if self._is_current:
            name_label.setStyleSheet(f"font-weight: 600; color: {c['accent']};")
        ...
        if preview:
            ...
            preview_label.setStyleSheet(f"color: {c['muted']}; font-size: 11px;")
        ...
        self._time_label.setStyleSheet(f"color: {c['muted']}; font-size: 11px;")
