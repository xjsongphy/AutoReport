...
class ConfigDialog(QDialog):
    ...
    def _apply_style(self) -> None:
        ...
        c = {
            ...
            "cardBg": "#252526" if dark else "#ffffff",
            ...
            "secondaryBtnBg": "#2b2b2b" if dark else "#ffffff",
            "secondaryBtnFg": "#cccccc" if dark else "#374151",
            "secondaryBtnBorder": "#3c3c3c" if dark else "#d1d5db",
            "secondaryBtnHoverBg": "#3c3c3c" if dark else "#f9fafb",
            "secondaryBtnHoverBorder": "#4f4f4f" if dark else "#9ca3af",
            ...
            "presetBtnBg": "#252526" if dark else "#f8fafc",
            "presetBtnFg": "#cccccc" if dark else "#334155",
            "presetBtnBorder": "#2b2b2b" if dark else "#e2e8f0",
            "presetBtnHoverBg": "#2b2b2b" if dark else "#f1f5f9",
