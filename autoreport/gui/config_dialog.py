...
class ConfigDialog(QDialog):
    ...
    def _apply_style(self) -> None:
        ...
        c = {
            "headerBg": "#1e1e2e" if dark else "#f8fafc",
            "headerBorder": "#313244" if dark else "#e2e8f0",
            "titleFg": "#cdd6f4" if dark else "#0f172a",
            "subtitleFg": "#a6adc8" if dark else "#64748b",
            "footerBg": "#1e1e2e" if dark else "#f8fafc",
            "footerBorder": "#313244" if dark else "#e2e8f0",
            "cardBg": "#262637" if dark else "#ffffff",
            "cardBorder": "#313244" if dark else "#e2e8f0",
            "nameFg": "#cdd6f4" if dark else "#1e293b",
            "descFg": "#6c7086" if dark else "#94a3b8",
            "envFg": "#a6e3a1" if dark else "#059669",
            "envBg": "#1e3a2e" if dark else "#d1fae5",
            "primaryBtnBg": "#2563eb",
            "primaryBtnFg": "#ffffff",
            "primaryBtnHover": "#3b82f6" if dark else "#1d4ed8",
            "primaryBtnPressed": "#1d4ed8" if dark else "#1e40af",
            "secondaryBtnBg": "#313244" if dark else "#ffffff",
            "secondaryBtnFg": "#cdd6f4" if dark else "#374151",
            "secondaryBtnBorder": "#45475a" if dark else "#d1d5db",
            "secondaryBtnHoverBg": "#45475a" if dark else "#f9fafb",
            "secondaryBtnHoverBorder": "#585b70" if dark else "#9ca3af",
            "resetFg": "#6c7086" if dark else "#6b7280",
            "resetHoverFg": "#f38ba8" if dark else "#dc2626",
            "testFg": "#89b4fa" if dark else "#2563eb",
            "testBorder": "#89b4fa" if dark else "#2563eb",
            "testHoverBg": "#1e2a3e" if dark else "#eff6ff",
            "testDisabledFg": "#45475a" if dark else "#cbd5e1",
            "testDisabledBorder": "#313244" if dark else "#e2e8f0",
            "inputBorder": "#45475a" if dark else "#d1d5db",
            "inputFocusBorder": "#89b4fa" if dark else "#2563eb",
            "inputBg": "#1e1e2e" if dark else "#ffffff",
            "inputFg": "#cdd6f4" if dark else "#1e293b",
            "inputDisabledBg": "#181825" if dark else "#f1f5f9",
            "inputDisabledFg": "#585b70" if dark else "#94a3b8",
            "checkFg": "#cdd6f4" if dark else "#374151",
            "bodyBg": "#11111b" if dark else "#ffffff",
        }
